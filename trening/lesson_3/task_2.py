...
def user_data(name='', surname='', year_of_birth='', citi='', email='', phone_number=''):
    name = input('Введите имя: ')
    surname = input('Введите фамилию: ')
    year_of_birth = input('Введите год рождения: ')
    citi = input('Введите город проживания: ')
    email = input('Введите ваш email: ')
    phone_number = input('Введите свои номер телефона: ')
    print(f'Имя: {name}, Фамилия: {surname}, Год рождения: {year_of_birth}, Город проживания: {citi}, email: {email}, '
